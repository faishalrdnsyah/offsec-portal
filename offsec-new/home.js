...
let tasks = [
  { id: 1, desc: 'Triage critical SQLi on Northstar Bank - Aegis (FND-1042)',         proj: 'Northstar Bank Core Aegis VA — Q2',   pic: 'Abu Rizal Mahdi',  due: '2026-05-27', st: 'In Progress' },
  { id: 2, desc: 'Re-test default Tomcat manager creds on Wahana Motorindo - Sentinel',     proj: 'Wahana Motorindo Sentinel Web Audit',      pic: 'Abu Rizal Mahdi',  due: '2026-05-29', st: 'To Do' },
  { id: 3, desc: 'Draft RA narrative — Trimatra Auto Orion hard-coded API key',        proj: 'Trimatra Auto Orion Mobile Pentest',  pic: 'Abu Rizal Mahdi',  due: '2026-05-25', st: 'In Review' },
  { id: 4, desc: 'Verify SSRF remediation on Trimatra Auto - Helios webhook',          proj: 'Trimatra Auto Helios Interface VAPT', pic: 'Budi',             due: '2026-06-03', st: 'To Do' },
  { id: 5, desc: 'Finalize Wahana Motorindo Nova Pentest report',                 proj: 'Wahana Motorindo Nova Pentest',  pic: 'Sarah Park',       due: '2026-04-30', st: 'Done' },
];
let nextId = 6;
let filter = 'all';
