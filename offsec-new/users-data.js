...
const USERS = [
  ...
  { id:'U-006', name:'Mark Diaz',          username:'mark.diaz',     email:'mark.diaz@northstarbank.co.id',          role:'app-pic', status:'Active',   created:'2024-05-09', lastSeen:'2026-05-22T13:21:00', mfa:true,  projects:3 },
  { id:'U-007', name:'Ari Wibowo',         username:'ari.wibowo',    email:'ari.wibowo@trimatraauto.co.id',         role:'app-pic', status:'Active',   created:'2024-06-15', lastSeen:'2026-05-25T07:40:00', mfa:true,  projects:5 },
  { id:'U-008', name:'Maya Lim',           username:'maya.lim',      email:'maya.lim@wahanamotorindo.co.id',         role:'app-pic', status:'Active',   created:'2024-07-02', lastSeen:'2026-05-24T15:08:00', mfa:false, projects:4 },
  { id:'U-009', name:'Reza Pratama',       username:'reza.pratama',  email:'reza.pratama@northstarbank.co.id',       role:'app-pic', status:'Inactive', created:'2024-01-20', lastSeen:'2026-02-10T10:00:00', mfa:false, projects:2 },
  ...
  { id:'U-016', name:'Tomi Wijaya',        username:'tomi.wijaya',   email:'tomi.wijaya@trimatraauto.co.id',        role:'app-pic', status:'Active',   created:'2025-03-22', lastSeen:'2026-05-23T11:30:00', mfa:false, projects:2 },
  { id:'U-017', name:'Hendra Setiawan',    username:'hendra.s',      email:'hendra.setiawan@wahanamotorindo.co.id',  role:'app-pic', status:'Locked',   created:'2024-12-01', lastSeen:'2026-04-18T09:08:00', mfa:false, projects:1 },
